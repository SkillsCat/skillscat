export interface IndexingMessage {
  ...
  discoveryPathOffset?: number;
  discoverySource?: 'github-repo-search' | 'github-events' | 'github-code-search' | 'github-repo-search-html' | 'x-search' | 'github-topics' | 'awesome-lists' | 'bluesky-search';
