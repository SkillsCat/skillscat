...
export interface GithubEventsEnv extends BaseEnv {
  ...
  GITHUB_EVENT_QUEUE_DEDUP_TTL_SECONDS?: string;
  GITHUB_REPO_QUEUE_DEDUP_TTL_SECONDS?: string;
  GITHUB_HTML_SEARCH_DISCOVERY_ENABLED?: string;
  GITHUB_HTML_SEARCH_DISCOVERY_INTERVAL_SECONDS?: string;
  GITHUB_HTML_SEARCH_QUERIES?: string;
  GITHUB_HTML_SEARCH_PAGES?: string;
  GITHUB_HTML_SEARCH_MAX_CANDIDATES?: string;
  GITHUB_SEARCH_BACKFILL_ENABLED?: string;
  GITHUB_SEARCH_BACKFILL_INTERVAL_SECONDS?: string;
  GITHUB_SEARCH_BACKFILL_START_DATE?: string;
...
export interface SearchPrecomputeEnv {
  ...
  SITEMAP_PREWARM_MAX_PATHS?: string;
  SITEMAP_PREWARM_TIME_BUDGET_MS?: string;
