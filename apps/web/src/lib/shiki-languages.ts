...
export type ShikiLanguageRegistration = Parameters<HighlighterCore['loadLanguage']>[0];
export type ShikiThemeRegistration = Exclude<Parameters<HighlighterCore['loadTheme']>[0], 'none'>;
...
export function normalizeShikiLanguage(language: string | null | undefined): string {
